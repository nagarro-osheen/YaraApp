...
public class ProductDTO {
	...
	public ProductDTO(ObjectId id, String productCode, String categoryId, String productName, String description,
			List<String> tags, List<Object> reviews, double price, String mainImageUrl, List<String> imageUrls,
